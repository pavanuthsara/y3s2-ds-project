...
const NAV_ITEMS = [
  ...
  { id: "files",            label: "Files & Reports",    icon: "📁" },
  { id: "history",          label: "Health History",     icon: "📋" },
  { id: "prescriptions",    label: "Prescriptions",      icon: "💊" },
  { id: "book-appointment", label: "Book Appointment",   icon: "📅" },
  { id: "my-appointments",  label: "My Appointments",    icon: "🗓️" },
  { id: "payments",         label: "Payments",           icon: "💳" },
  { id: "symptom-checker",  label: "AI Symptom Checker", icon: "🤖" },
];
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-slate-200 sticky top-0 z-10">
          ...
          <span className="font-semibold text-slate-800 text-sm">
            {activeNavItem?.icon} {activeNavItem?.label ?? "Patient Portal"}
          </span>
        </div>
